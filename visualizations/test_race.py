...
class Race(unittest.TestCase):
    ...
    def test_make_lap_log(self):
        ...
        self.assertEqual(83.456, list(result)[0].laps[1].time)
        self.assertEqual(pandas.to_datetime("2026-01-01 00:00:00"), list(result)[0].laps[1].at)
        ...
        self.assertEqual(82.789, list(result)[0].laps[2].time)
        self.assertEqual(pandas.to_datetime("2026-01-01 00:01:23"), list(result)[0].laps[2].at)
        ...
        self.assertEqual(83.000, list(result)[1].laps[1].time)
        self.assertEqual(pandas.to_datetime("2026-01-01 00:00:00"), list(result)[1].laps[1].at)
